...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('Transactions') }}'><i class='nav-icon fa fa-question'></i> Transactions</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('Pattern') }}'><i class='nav-icon fa fa-question'></i> Patterns</a></li>
